...
import TAJ_02 from '../../assets/TAJ_02.png';
import './navbar.css';
    ...
    <div className="project_navbar">
      <div className="project_navbar-links">
        <div className="project_navbar-logo">
          <img src={TAJ_02} alt="logo" className="logo"/>
        </div>
      ...
      <div className='project_navbar-menu'>
        {toggleMenu
          ?<RiCloseLine color="#524633" size={27} onClick={() => setToggleMenu(false)}/>
          :<RiMenu3Line color="#524633" size={27} onClick={() => setToggleMenu(true)}/>
        }
        {toggleMenu &&(
